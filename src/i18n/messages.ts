export const messages = {
  ko: {
    ...
    deviceSyncCreateHint: '현재 캔버스를 동기화 캔버스로 전환하고 연결 코드를 생성합니다.',
    deviceSyncJoinHint: '다른 기기에서 받은 코드를 입력하면 같은 캔버스로 연결됩니다.',
    ...
    deviceSyncCodePlaceholder: '예: ABCD-EFGH',
  ...
  en: {
    ...
    deviceSyncCreateHint: 'This will switch your current canvas to a synced canvas and generate a link code.',
    deviceSyncJoinHint: 'Enter the code from your other device to link to the same canvas.',
    ...
    deviceSyncCodePlaceholder: 'e.g., ABCD-EFGH',
